(function(){
	...
	const tuneStrings = [
	 ...
	 const propsStrings = [
        ...
        "%%USER%% disse, Essa é xou de bola :thumbsup: %%DJ%%.",
        ...
        "%%USER%% disse, Amo! :purple_heart: para %%DJ%%.",
        "%%USER%% disse, Adoro! :purple_heart: para %%DJ%%.",
	...
	function extend() {
		...
		scriptLink: "https://raw.githack.com/DavidStefansky/Catharsis-Club-Brazil/master/extension.js",
		playLive: true,
		roomLock: false,
		startupCap: 1,
		startupVolume: 0,
		...
		youtubeLink: null,
		discordLink: "https://discord.gg/eE5jNPZ",
